defmodule SlackColorThemeGeneratorTest do
  ...
  test ".generate returns a v2 slack theme by default" do
    assert (@fixture |> SlackColorThemeGenerator.generate) == "#D1A6B0,#FFFFFF,#F0CFD6,#0EBE0A,#0485DD,#1A0F98,#F5E805,#ED341C"
  end
